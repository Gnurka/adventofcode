...
var input2 = "aaaa[qwer]tyui";
var input3 = "ioxxoj[asdfgh]zxcvbn";

function step1() {
  var abba = /([a-z])(?!\1)([a-z])\2\1/g;
  var bracketAbba = /\[\w*([a-z])(?!\1)([a-z])\2\1\w*\]/g;
  var brackets = /\[\w*\]/g;

  var valids = 0;
  input.split("\n").forEach(function(line) {
    var outside = line.split(brackets);
    var inside = line.match(brackets);

    var numOutside = outside.filter(function(o) {
      return o.match(abba);
    }).length;

    var numInside = inside.filter(function(i) {
      return i.match(abba);
    }).length;
